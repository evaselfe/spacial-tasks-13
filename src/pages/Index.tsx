...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background to-background/95 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            setActiveTab("login");
          }} className="border-primary/20 hover:border-primary bg-red-600 hover:bg-red-500 text-slate-50">
              Logout
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className={`cursor-pointer transition-all duration-300 hover:scale-105 ${activeTab === "manage" ? "scale-105" : ""}`} onClick={() => setActiveTab("manage")}>
            <div className={`relative overflow-hidden rounded-lg border-2 transition-all duration-300 ${activeTab === "manage" ? "border-coordinator shadow-xl bg-coordinator/10" : "border-border hover:border-coordinator/50 hover:shadow-lg bg-card"}`}>
              ...
              <div className="relative p-6 bg-teal-200">
          ...
          <div className={`cursor-pointer transition-all duration-300 hover:scale-105 ${activeTab === "view" ? "scale-105" : ""}`} onClick={() => setActiveTab("view")}>
            <div className={`relative overflow-hidden rounded-lg border-2 transition-all duration-300 ${activeTab === "view" ? "border-supervisor shadow-xl bg-supervisor/10" : "border-border hover:border-supervisor/50 hover:shadow-lg bg-card"}`}>
              ...
              <div className="relative p-6 bg-fuchsia-200">
                <div className="flex items-center gap-3 mb-3">
